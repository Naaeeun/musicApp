	...
	<section class="aui-scrollView">
		...
		<div class="aui-chang-list">
			<div class="aui-user-img">
				<img class="aui-user-img-img" :scr="$store.state.user.userDetail.profile.avatarUrl" alt="">
			</div>
			<div class="aui-user-text">
				...
				<button v-if="$store.state.user.userDetail.profile.vipType==0">开通会员</button>
			</div>
...
<script>
//console.log($store.state.user.userDetail.profile.avatarUrl.nickname);
</script>
